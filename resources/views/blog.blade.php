...
<html lang="en">
  ...
  <head>
    ...
    <title>BloggenUI - Blog Post</title>
              ...
              <div class="row">
                      ...
                      <ul>
                          @foreach ($comments as $comment)
                            <li>
                                ...
                                <img src=" {{ $comment->author_photo }} " alt="">
                                </div>
                                <div class="right-content">
                                <h4>{{ $comment->author }}<span>{{ $comment->created_at->diffForHumans() }}</span></h4>
                                <p>{{ $comment->body }}</p>
                                </div>
                            </li>
                            <li class="replied">
                ...
                <div class="col-lg-12">
                  <div class="sidebar-item submit-comment">
                    ...
                    <div class="content">
                    {!! Form::open(['method' => 'POST', 'id' => 'comment', 'action' => 'App\Http\Controllers\AdminCommentController@store']) !!}
                        <div class="row">
                          <div class="col-lg-12">
                            <fieldset>
